...
export async function GET() {
    try {
        const response = await axios.get(
            `https://www.aladin.co.kr/ttb/api/ItemList.aspx?ttbkey=${process.env.ALADIN_TTB_KEY}&QueryType=BlogBest&MaxResults=10&start=1&SearchTarget=Book&output=js&Version=20131101`
        );
